...
public class YandexMapController implements
    ...
    public YandexMapController(
        ...
        setupCustomLayers(Utils.tileProvidersFromJson((ArrayList<Map<String, Object>>) params.get("tiles")));
    }
    ...
    private void setupCustomLayers(ArrayList<NetworkTileProvider> providers) {
        if (providers == null) {
            return;
        }
    ...
    public void updateTiles(MethodCall call) {
        ArrayList<Map<String, Object>> params = (ArrayList<Map<String, java.lang.Object>>) call.arguments;
        
        setupCustomLayers(Utils.tileProvidersFromJson(params));
    }
